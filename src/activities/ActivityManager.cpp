...
#include "home/PaperbitFetchActivity.h"
#include "home/VaultActivity.h"
...
void ActivityManager::goToVault() { replaceActivity(std::make_unique<VaultActivity>(renderer, mappedInput)); }

void ActivityManager::goToPaperbitFetch() {
